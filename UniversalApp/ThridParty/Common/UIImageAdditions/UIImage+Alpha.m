...
-(UIImage *)imageWithShadow:(UIColor*)_shadowColor
    ...
    CGContextRef shadowContext = CGBitmapContextCreate(NULL, self.size.width + w, self.size.height + h, CGImageGetBitsPerComponent(self.CGImage), 0, colourSpace, kCGBitmapByteOrderDefault);
