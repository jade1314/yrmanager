...
#define NSArrayIndex(__ARRAYNAME__,__INDEX__) NSArrayObjectMaybeNil(__ARRAYNAME__, __INDEX__), NSArrayObjectMaybeNil(__ARRAYNAME__, __INDEX__+1), NSArrayObjectMaybeNil(__ARRAYNAME__, __INDEX__+2), NSArrayObjectMaybeNil(__ARRAYNAME__, __INDEX__+3), NSArrayObjectMaybeNil(__ARRAYNAME__, __INDEX__+4), NSArrayObjectMaybeNil(__ARRAYNAME__, __INDEX__+5), NSArrayObjectMaybeNil(__ARRAYNAME__, __INDEX__+6), NSArrayObjectMaybeNil(__ARRAYNAME__, __INDEX__+7), NSArrayObjectMaybeNil(__ARRAYNAME__, __INDEX__+8), NSArrayObjectMaybeNil(__ARRAYNAME__, __INDEX__+9)


#define NSArrayArgumentsList(__ARRAY__,__INDEX__) NSArrayIndex(__ARRAY__,__INDEX__),\
((__INDEX__ + 10)>= [__ARRAY__ count]) ? nil : NSArrayIndex(__ARRAY__,__INDEX__+10),\
((__INDEX__ + 20)>= [__ARRAY__ count]) ? nil : NSArrayIndex(__ARRAY__,__INDEX__+20),\
((__INDEX__ + 30)>= [__ARRAY__ count]) ? nil : NSArrayIndex(__ARRAY__,__INDEX__+30),\
((__INDEX__ + 40)>= [__ARRAY__ count]) ? nil : NSArrayIndex(__ARRAY__,__INDEX__+40),\
((__INDEX__ + 50)>= [__ARRAY__ count]) ? nil : NSArrayIndex(__ARRAY__,__INDEX__+50),\
((__INDEX__ + 60)>= [__ARRAY__ count]) ? nil : NSArrayIndex(__ARRAY__,__INDEX__+60),\
((__INDEX__ + 70)>= [__ARRAY__ count]) ? nil : NSArrayIndex(__ARRAY__,__INDEX__+70),\
((__INDEX__ + 80)>= [__ARRAY__ count]) ? nil : NSArrayIndex(__ARRAY__,__INDEX__+80),\
((__INDEX__ + 90)>= [__ARRAY__ count]) ? nil : NSArrayIndex(__ARRAY__,__INDEX__+90),\
((__INDEX__ + 100)>= [__ARRAY__ count]) ? nil : NSArrayIndex(__ARRAY__,__INDEX__+100),nil
...
otherButtonTitles:(NSArray *)otherButtonTitles
    ...
    UIActionSheet *actionSheet = [[self alloc] initWithTitle:title
                                           ...
                                           cancelButtonTitle:cancelButtonTitle
                                      destructiveButtonTitle:destructiveButtonTitle
                                           otherButtonTitles:NSArrayArgumentsList(otherButtonTitles,0)];
    if (tapBlock) {
        actionSheet.tapBlock = tapBlock;
    }
    ...
    if (iOS7orLater) {
        [actionSheet drawRect:actionSheet.frame];
    }
#if !__has_feature(objc_arc)
    [actionSheet release];
#endif
