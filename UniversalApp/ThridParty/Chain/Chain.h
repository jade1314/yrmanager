...
typedef enum {
    /** No error. */
    ChainErrorNone = noErr,
    
    /** Some of the arguments were invalid. */
    ChainErrorBadArguments = -1001,
    
    /** There was no password. */
    ChainErrorNoPassword = -1002,
    
    /** One or more parameters passed internally were not valid. */
    ChainErrorInvalidParameter = errSecParam,
    
    /** Failed to allocate memory. */
    ChainErrorFailedToAllocated = errSecAllocate,
    
    /** No trust results are available. */
    ChainErrorNotAvailable = errSecNotAvailable,
    
    /** Authorization/Authentication failed. */
    ChainErrorAuthorizationFailed = errSecAuthFailed,
    
    /** The item already exists. */
    ChainErrorDuplicatedItem = errSecDuplicateItem,
    
    /** The item cannot be found.*/
    ChainErrorNotFound = errSecItemNotFound,
    
    /** Interaction with the Security Server is not allowed. */
    ChainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
    
    /** Unable to decode the provided data. */
    ChainErrorFailedToDecode = errSecDecode
} ChainErrorCode;

extern NSString *const kChainErrorDomain;

/** Account name. */
extern NSString *const kChainAccountKey;
 ...
 */
extern NSString *const kChainCreatedAtKey;

/** Item class. */
extern NSString *const kChainClassKey;

/** Item description. */
extern NSString *const kChainDescriptionKey;

/** Item label. */
extern NSString *const kChainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kChainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kChainWhereKey;
...
/**
 ...
 Chain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in Chain.h for a list of keys that can be used when accessing the
