...
- (void)configureProperty
{
    ...
    _buttonFont = [UIFont fontWithName:FONT_HELVETICANEUE size:18];;
...
- (void)addTextLabels
{
    ...
    titleLabel.font = [UIFont fontWithName:FONT_HELVETICANEUEBOLD size:18];
    ...
    messageLabel.font = [UIFont fontWithName:FONT_HELVETICANEUE size:15];
