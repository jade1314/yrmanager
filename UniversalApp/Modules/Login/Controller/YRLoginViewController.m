...
@interface YRLoginViewController ()<CLLocationManagerDelegate,UIScrollViewDelegate>
{
...
- (void) initBackView {
    ...
    _topImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, KScreenWidth, KScreenHeight - 64)];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    if (scrollView.contentOffset.y < - KScreenHeight + 10) {
//        [AppDelegate shareAppDelegate].mainTabBar//jadejade
    }
}
