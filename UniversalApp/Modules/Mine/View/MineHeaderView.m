...
//        [self.headImgView setImageWithURL:[NSURL URLWithString:userInfo.photo] placeholder:[UIImage imageWithColor:KGrayColor]];
        ...
        [self.headImgView sd_setImageWithURL:[NSURL URLWithString:@"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1503377311744&di=a784e64d1cce362c663f3480b8465961&imgtype=0&src=http%3A%2F%2Fww2.sinaimg.cn%2Flarge%2F85cccab3gw1etdit7s3nzg2074074twy.jpg"] placeholderImage:[UIImage imageWithColor:KGrayColor]];
    }
}
#pragma mark ————— 头像点击 —————
-(void)headViewClick{
