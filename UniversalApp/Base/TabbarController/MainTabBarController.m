...
//    [self setupChildViewController:homeVC title:@"首页" imageName:@"icon_tabbar_homepage" seleceImageName:@"icon_tabbar_homepage_selected"];
    ...
    KFCViewController *homeVC = [[KFCViewController alloc]init];
    [self setupChildViewController:homeVC title:@"KFC" imageName:@"icon_tabbar_homepage" seleceImageName:@"icon_tabbar_homepage_selected"];
